...
@WebServlet(name = "consultarfuncionariocontroller", urlPatterns = {"/consultarfuncionariocontroller"})
...
public class ConsultarFuncionarioController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/WEB-INF/consultarFuncionario.jsp").forward(request, response);
    }
