                    ...
                    <div>
                        ...
                        <c:forEach var="estoque" items="${search}" >
                            <tr>
                                ...
                                <td><a href="UpdateEstoque?action=upd&id=${estoque.idProduto}"><button button class="buttomUpdate" type="submit" value="${estoque.idProduto}" name="id" style="width: 70px; height: 30px">Inserir ou Remover</button></a></td>                 
                            </c:forEach>
                            </form>
                            </table>
                    </div>
