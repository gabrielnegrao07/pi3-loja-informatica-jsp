                    ...
                    <div>
                        ...
                        <c:forEach var="categoria" items="${search}" >
                            ...
                            <form method="post" action="${pageContext.request.contextPath}/DeleteCategoria">
                                <td><button class="buttomDeletar" type="submit" value="${categoria.id}" name="id" style="width: 70px; height: 30px">Delete</button></td>
                            </form>     
                            <td><a href="UpdateCategoria?action=upd&id=${categoria.id}"><button class="buttomUpdate" type="submit" value="${categoria.id}" name="id" style="width: 70px; height: 30px">Update</button></a></td>
                            </tr>                 
                        </c:forEach>
                        </form>
                </table>
