                    ...
                    <div>
                        ...
                        <c:forEach var="produto" items="${search}" >
                            ...
                            <form method="post" action="${pageContext.request.contextPath}/DeleteProduto">
                                <td><button class="buttomDeletar" type="submit" value="${produto.id}" name="id" style="width: 70px; height: 30px">Delete</button></td>
                            </form>     
                            <td><a href="UpdateProduto?action=upd&id=${produto.id}"><button class="buttomUpdate" type="submit" value="${produto.id}" name="id" style="width: 70px; height: 30px">Atualizar</button></a></td>
                            </tr>               
                        </c:forEach>
                        </form>
                </table>
