                    ...
                    <div>
                        ...
                        <c:forEach var="filial" items="${search}" >
                            ...
                            <form method="post" action="${pageContext.request.contextPath}/DeleteFilial">
                                <td><button class="buttomDeletar" type="submit" value="${filial.id}" name="id" style="width: 70px; height: 30px">Delete</button></td>
                            </form>     
                            <td><a href="UpdateFilial?action=upd&id=${filial.id}"><button class="buttomUpdate" type="submit" value="${filial.id}" name="id" style="width: 70px; height: 30px">Atualizar</button></a></td>
                            </tr>                    
                        </c:forEach>
                        </form>
                </table>
