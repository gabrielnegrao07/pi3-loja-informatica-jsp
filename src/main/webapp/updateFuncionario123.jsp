...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" hresf="CSS\estiloFuncionario.css">
    <head>
    <body>	
        <div class="container">
            <header>
            ...
            <div class="formulario">
                <form autocomplete="off" action="UpdateFuncionario" method="post">
                    <input type="hidden" name="id"  value="${funcionario.id}" style="width: 300px; height: 20px">
